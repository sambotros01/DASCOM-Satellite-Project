...
class EventsController: UIViewController {
    ...
    @IBOutlet weak var upsOverviewModule: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        if (GlobalVariables.editedEventsPage){
            upsOverviewModule.isHidden = true
            self.contentView.frame.size.height = 2000
        }
        else{
            upsOverviewModule.isHidden = false
            self.contentView.frame.size.height = 3200
        }
